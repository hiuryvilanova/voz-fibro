...
export const artigos: Artigo[] = [
  {
    ...
    resumo:
      "Entenda a condição, sua prevalência no Distrito Federal e por que ela ainda é tão invisibilizada.",
    ...
    conteudo: [
      ...
      "Segundo o Ministério da Saúde, citando a Sociedade Brasileira de Reumatologia, cerca de 3% da população pode conviver com fibromialgia, com predominância em mulheres — o que representa milhares de moradores do Distrito Federal.",
      "A fibromialgia não é 'frescura', 'preguiça' nem 'coisa da cabeça'. É uma condição reconhecida pela medicina que afeta a qualidade de vida de muitas pessoas em Brasília e em todo o país.",
  ...
  },
  {
    ...
    conteudo: [
      ...
      "**Legislação do Distrito Federal** — o DF possui normas de atendimento prioritário e proteção social. Verifique se há legislação aplicável à sua região administrativa.",
  ...
  },
  {
    ...
    atualizadoEm: "2026-06-18",
    conteudo: [
      "O SUS oferece atendimento para fibromialgia em Brasília, mas o acesso pode variar conforme a região administrativa e a disponibilidade de especialistas.",
      "**Passo 1:** procure a unidade básica de saúde (UBS) mais próxima da sua região administrativa e agende consulta com médico de família ou clínico geral.",
      ...
      "Se encontrar dificuldades de acesso, procure a ouvidoria do SUS no DF ou a defensoria pública.",
    ],
  },
  {
  ...
  },
  {
    ...
    conteudo: [
      ...
      "Com seu consentimento explícito, dados agregados e anônimos podem mostrar a realidade da fibromialgia em Brasília: tempo até diagnóstico, dificuldades no SUS, impacto no trabalho e falta de especialistas no DF.",
