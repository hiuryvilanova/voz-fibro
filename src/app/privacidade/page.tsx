...
export default function PrivacidadePage() {
  return <article className="mx-auto max-w-3xl px-5 py-10 sm:px-8 sm:py-13">
    ...
    <p className="mt-5 text-lg leading-relaxed text-muted">A Voz da Fibro adota princípios de finalidade, necessidade, transparência e segurança previstos na Lei Geral de Proteção de Dados.</p>
    <div className="mt-10 space-y-8 leading-relaxed text-muted">
      <section><h2 className="text-xl font-bold text-foreground">Dados utilizados</h2><p className="mt-2">Nome, e-mail, estado, cidade, telefone, profissão e validação de CPF são usados para criar a conta, evitar duplicidades, organizar serviços regionais e proteger a integridade das participações.</p></section>
