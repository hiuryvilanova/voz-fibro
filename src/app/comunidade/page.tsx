    ...
    <div className="bg-background">
      <section className="border-b border-border bg-white">
        <div className="mx-auto max-w-7xl px-5 py-10 sm:px-8 sm:py-13 lg:px-10">
          ...
          <h1 className="mt-2 text-3xl font-bold text-foreground sm:text-4xl">Uma comunidade para Brasília</h1>
          <p className="mt-5 max-w-3xl text-lg leading-relaxed text-muted">
            Espaços moderados para compartilhar experiências, encontrar informação e construir relações de apoio nas regiões administrativas do DF.
          </p>
