...
export default async function CompletarCadastroPage() {
  ...
  return <div className="mx-auto max-w-2xl px-5 py-10 sm:px-8 sm:py-13">
    ...
    <p className="mt-4 leading-relaxed text-muted">Precisamos dessas informações para validar sua conta, organizar serviços por região administrativa do DF e manter um cadastro por pessoa.</p>
