...
export const metadata: Metadata = { title: "Entrar", description: "Crie sua conta ou entre na Voz da Fibro em Brasília." };
...
export default async function EntrarPage({ searchParams }: { searchParams: Promise<{ error?: string }> }) {
  ...
  return <div className="bg-background">
    <PageHero eyebrow="Acesso seguro" title="Entre na Voz da Fibro" description="Crie sua conta para participar da comunidade em Brasília, inscrever-se em rodas, responder pesquisas e acessar recursos personalizados no DF." />
